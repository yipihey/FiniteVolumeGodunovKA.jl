...
"`s -> NamedTuple`: the system's captured stencil as DATA — `(nvars, vidx, params, phys=(fn=(argname,
body_expr),...))`. Generated by `@fvsystem`; consumed by the transpile-to-CUDA-C backend."
function _fvmeta end
...
include("backend_cpu_3d.jl")
include("backend_cpu_simd_3d.jl")
include("backend_cuda_2d.jl")
include("backend_cuda_3d.jl")
include("systems.jl")
include("euler_colors.jl")
include("euler_de.jl")
include("euler_de_colors.jl")
